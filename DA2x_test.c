...
DA2x_Result test_0(){
  ...
  DA2x a0 ,*a0p; a0p=&a0;
  DA2x_init(a0p ,byte_length_of(int));

  f[i++] = DA2x_element_byte_length(a0p) == byte_length_of(int);
  f[i++] = DA2x_byte_length(a0p) == 0;
  f[i++] = DA2x_empty(a0p);
  f[i++] = DA2x_allocation_byte_length(a0p) == byte_length_of(int) * DA2x_INITIAL_ALLOCATION_ELEMENT_LENGTH;
...
DA2x_Result test_1(){
  ...
  //
    ...
    f[i++] = DA2x_allocation_byte_length(a0p) == byte_length_of(int) * 4;  // array will not contract below minimum byte_length
    f[i++] = DA2x_pop_read(a0p ,&y) && y == 1; // after this pop, the data length will halve again
    f[i++] = DA2x_allocation_byte_length(a0p) == byte_length_of(int) * 4;
...
DA2x_Result test_2(){
  ...
  f[i++] = DA2x_allocation_byte_length(a0) == byte_length_of(int) * DA2x_INITIAL_ALLOCATION_ELEMENT_LENGTH;
  f[i++] = DA2x_empty(a0);
  ...
  //
    DA2x_push_write(a0 ,&x);
    f[i++] = DA2x_allocation_byte_length(a0) == byte_length_of(int) * DA2x_INITIAL_ALLOCATION_ELEMENT_LENGTH * 2;
    f[i++] = !DA2x_empty(a0);
  ...
  //
    DA2x_push_write(a0 ,&x);
    f[i++] = DA2x_allocation_byte_length(a0) == byte_length_of(int) * DA2x_INITIAL_ALLOCATION_ELEMENT_LENGTH * 4;
    f[i++] = !DA2x_empty(a0);
  ...
  // the array is now empty
  //
    f[i++] = DA2x_element_byte_length(a0) == byte_length_of(int);
    f[i++] = DA2x_byte_length(a0) == 0;
    f[i++] = DA2x_empty(a0);
