...
TM2x·alloc_Tape_heap:{
  CLib·mallocn·args.pt      = TM2x·alloc_Tape_heap·args.tape;
  CLib·mallocn·args.n       = byte_n_of(TM2x·Tape);
  CLib·mallocn·args.nominal = TM2x·alloc_Tape_heap·args.malloc_nominal;
  CLib·mallocn·args.fail    = TM2x·alloc_Tape_heap·args.malloc_fail;
