...
#include "inclusive·mul_ext·text.h"
#include "inclusive·text.h"
#include "TM2x·alloc_header_heap·text.h"
#include "TM2x·alloc_array_bytes·text.h"
#include "TM2x·alloc_array_elements·text.h"
...
#include "TM2x·copy_contiguous_bytes·text.h"
#include "TM2x·copy_contiguous_elements·text.h"
#include "TM2x·dealloc_header_heap·text.h"
#include "TM2x·dealloc_array·text.h"
